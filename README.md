...
12/2022 – Present 
- Worked on a Quantum computing research using QAOA for traveling salesmanship problem via python library Qiskit then moved to IBM quantum computing. Goal is to find the optimal route with the lowest cost across several cities that converges. 
- Developed a mental health detection model for teenagers, adopted by 3 academic research teams. 
- Delivered a reinforcement learning-based network intrusion detection system (NSL KDD dataset) with 94% F1-score. 
**Key Features:**  
...
- Created an image classification model (CIFAR-10) using CNNs, achieving 95% accuracy and deployed using Flask for website integration.     
  activities.  
